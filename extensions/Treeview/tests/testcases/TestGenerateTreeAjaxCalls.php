...
class TestGenerateTreeAjaxCalls extends PHPUnit_Framework_TestCase {
	...
	function testInitOnload() {
		...
		$expected = array(
			...
			array('name' => "Jacob Grimm", 'link' => "Jacob_Grimm", 'depth' => 4, 'leaf' => 1),
			array('name' => "Wilhelm Grimm", 'link' => "Wilhelm_Grimm", 'depth' => 4, 'leaf' => 1),
			array('name' => "Grimms Märchen", 'link' => "Grimms_M%C3%A4rchen", 'depth' => 3),
			array('name' => "Blaues Licht", 'link' => "Blaues_Licht", 'depth' => 4, 'leaf' => 1),
			array('name' => "Der Wolf und die 7 Geißlein", 'link' => "Der_Wolf_und_die_7_Gei%C3%9Flein", 'depth' => 4, 'leaf' => 1),
			array('name' => "Die 3 Schlangenblätter", 'link' => "Die_3_Schlangenbl%C3%A4tter", 'depth' => 4, 'leaf' => 1),
			array('name' => "Frau Holle", 'link' => "Frau_Holle", 'depth' => 4),
			array('name' => "Goldmarie", 'link' => "Goldmarie", 'depth' => 5, 'leaf' => 1),
			array('name' => "Pechmarie", 'link' => "Pechmarie", 'depth' => 5, 'leaf' => 1),
			array('name' => "Hänsel und Gretel", 'link' => "H%C3%A4nsel_und_Gretel", 'depth' => 4, 'leaf' => 1),
			array('name' => "Rapunzel", 'link' => "Rapunzel", 'depth' => 4, 'leaf' => 1),
			array('name' => "Schneewittchen", 'link' => "Schneewittchen", 'depth' => 4, 'leaf' => 1),
			array('name' => "Waldhaus", 'link' => "Waldhaus", 'depth' => 4, 'leaf' => 1),
			array('name' => "Wilhelm Hauff", 'link' => "Wilhelm_Hauff", 'depth' => 3),
			array('name' => "Kleiner Muck", 'link' => "Kleiner_Muck", 'depth' => 4, 'leaf' => 1),
		);
		$res= $this->callWiki($params);
		$this->assertEquals($res->result, "success");
		$this->assertEquals($res->token, $token);
	...
	function testInitOnloadStartAndMaxdepth() {
		...
		$expected = array(
			...
			array('name' => "Jacob Grimm", 'link' => "Jacob_Grimm", 'depth' => 3, 'leaf' => 1),
			array('name' => "Wilhelm Grimm", 'link' => "Wilhelm_Grimm", 'depth' => 3, 'leaf' => 1),
			array('name' => "Grimms Märchen", 'link' => "Grimms_M%C3%A4rchen", 'depth' => 2),
			array('name' => "Blaues Licht", 'link' => "Blaues_Licht", 'depth' => 3, 'leaf' => 1),
			array('name' => "Der Wolf und die 7 Geißlein", 'link' => "Der_Wolf_und_die_7_Gei%C3%9Flein", 'depth' => 3, 'leaf' => 1),
			array('name' => "Die 3 Schlangenblätter", 'link' => "Die_3_Schlangenbl%C3%A4tter", 'depth' => 3, 'leaf' => 1),
			array('name' => "Frau Holle", 'link' => "Frau_Holle", 'depth' => 3, 'leaf' => 1),
			array('name' => "Hänsel und Gretel", 'link' => "H%C3%A4nsel_und_Gretel", 'depth' => 3, 'leaf' => 1),
			array('name' => "Rapunzel", 'link' => "Rapunzel", 'depth' => 3, 'leaf' => 1),
			array('name' => "Schneewittchen", 'link' => "Schneewittchen", 'depth' => 3, 'leaf' => 1),
			array('name' => "Waldhaus", 'link' => "Waldhaus", 'depth' => 3, 'leaf' => 1),
			array('name' => "Wilhelm Hauff", 'link' => "Wilhelm_Hauff", 'depth' => 2),
			array('name' => "Kleiner Muck", 'link' => "Kleiner_Muck", 'depth' => 3, 'leaf' => 1),
		);
		$res= $this->callWiki($params);
		$this->assertEquals($res->result, "success");
		$this->assertEquals($res->token, $token);
