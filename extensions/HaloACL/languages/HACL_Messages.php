...
$messages['en'] = array(
    ...
    'hacl_protected_element_missing' => 'There is no element with the name "$1" that can be protected.',
    'hacl_incorrect_case_for_SD'	=> 'This security descriptor has a wrong name. Try "$1" instead.',
...
$messages['de'] = array(
    ...
    'hacl_protected_element_missing' => 'Es gibt kein Element mit dem Namen "$1" das geschützt werden kann.',
    'hacl_incorrect_case_for_SD'	=> 'Diese Sicherheitsbeschreibung hat einen falschen Name. Verwenden Sie stattdessen "$1".',
