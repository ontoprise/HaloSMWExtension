                    ...
                    <div class="halocal_panel_content_row">
                       ...
                       <div class="halocal_panel_content_row">
                        ...
                        <div class="haloacl_panel_content_row_content">
                            ...
                            <input type="radio" value="on" name="right_descriptiontext_$panelid" class="right_descriptiontext_$panelid" checked/>&nbsp;on
                            <input type="radio" value="off" name="right_descriptiontext_$panelid" class="right_descriptiontext_$panelid" />&nbsp;off
                        </div>
                    </div>
