    ...
    $html .= <<<HTML
        ...
        <script type="javascript">
            ...
            gotoStep4 = function() {
                ...
                //checks and warnings
                var goAhead = false;
                if (YAHOO.haloacl.hasGroupsOrUsers('right_tabview_create_acl_modificationrights')) {goAhead=true; }
...
function getRightsContainer($panelid, $type = "readOnly") {
    ...
    $myGenericPanel = new HACL_GenericPanel($panelid+"_container", "Select...", "Select...");
