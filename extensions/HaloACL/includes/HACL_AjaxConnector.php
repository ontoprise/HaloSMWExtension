...
HTML;
    if($type != "readOnly") {
        $html .= <<<HTML
            ...
            <div class="haloacl_manageacl_contentmenu_element">
                <input class="haloacl_manageacl_filter  sub"  type="checkbox" name="namespace"/>&nbsp;Namepsace
            </div>
...
HTML;
   ...
   <div id="content_manageUsersPanel">
        ...
        <div id="haloacl_manageuser_contentlist">
            ...
            <div style="clear:both;border:1px solid;border-style:solid none none none;text-align:right">
...
HTML;
    ...
    <script>
        ...
        YAHOO.haloacl.deleteWhitelist = function(){
            ...
            console.log("deleteWhitelist called");
            var xml = "<?xml version=\"1.0\"  encoding=\"UTF-8\"?>";
            xml += "<whitelistContent>";
