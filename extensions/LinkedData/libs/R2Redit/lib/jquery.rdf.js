...
(function ($) {
  var
    ...
    uriRegex = /^<(([^>]|\\>)*)>$/,
    /* cb: add support for single quote literals as per sparql spec */
  ...
  $.rdf.databank.fn = $.rdf.databank.prototype = {
    ...
    load: function (data, opts) {
      ...
      if (url.scheme) {
        ...
        /* cb: copy over parsed namespaces */
        var opts = {};
        triples = parser.triples(data, opts);
		$.extend(this.namespaces, opts.namespaces);        
        for (i = 0; i < triples.length; i += 1) {
  ...
  $.rdf.literal.fn = $.rdf.literal.prototype = {
    ...
    init: function (value, options) {
      ...
      if (opts.datatype !== undefined) {
        ...
        if (m !== null) {
          this.value = (m[2] || m[4] || m[6]).replace(/\\"/g, '"').replace(/\\n/g, '\n').replace(/\\t/g, '\t').replace(/\\r/g, '\r');
          if (m[11]) {
            datatype = $.rdf.resource(m[11], opts);
