 ...
 * - LODSparqlQueryResult   : The complete result of a query
 * - LODSparqlResultRow     : One row in the result.
 * - LODSparqlResult        : The abstract base class of a single result value
 * - LODSparqlResultURI     : Representation of a result value which is a URI
 * - LODSparqlResultLiteral : Representation of a result value which is a literal
 * 
 ...
 * 
 */
class LODSparqlQueryResult {
	
	// array<LODSparqlResultRow>
	 ...
	 *
	 * @return array<LODSparqlResultRow>
	 * 		An array of rows.
	 */
	 ...
	 * this result object.
	 *
	 * @param LODSparqlResultRow $row
	 * 		One row of results.
	 */
	public function addRow(LODSparqlResultRow $row) {
		$this->mRows[] = $row;
	}
 ...
 * of class LODSparqlResult. The keys in this array are the names of the variables.
 * 
 * @author Thomas Schweitzer
 * 
 */
class LODSparqlResultRow {
	 ...
	 *
	 * @return array<string => LODSparqlResult>
	 */
	 ...
	 * @param string $variable
	 * 		Name of the variable
	 * @param LODSparqlResult $result
	 * 		This object describes the result.
	 */
	public function addResult($variable, LODSparqlResult $result) {
...
abstract class LODSparqlResult {
 ...
 *
 */
class LODSparqlResultURI extends LODSparqlResult{
 ...
 *
 */
class LODSparqlResultLiteral extends LODSparqlResult {
	// string (uri)
	 ...
	 */
	public function __construct($name, $value, $datatype = null, $language = null) {
