 ...
 */
/**
 * This file contains the class LODURIIntegrationValue. 
...
/**
 * The class LODURIIntegrationValue is derived from SMWURIIntegrationValue and 
 * overwrites the methods for getting wiki text. The returned values are 
 * augemented with meta-data from the triple store.
 * 
 * @author Thomas Schweitzer
 * 
 */
class LODURIIntegrationValue extends SMWURIIntegrationValue {
	//--- Private fields ---
