...
/**
 * This file defines the class LODSparqlQueryParser.
 * 
...
class LODSparqlQueryParser  {
	...
	/**
	 * Constructor for LODSparqlQueryParser
	 *
	 * @param string $query
...
//	public function setXY($xy)               {$this->mXY = $xy;}
	 ...
	 * 
	 * @param LODSparqlQueryVisitor $visitor
	 * 		The methods of this visitor are called for the nodes of the query's
	 * 		structure tree.
	 */
	public function visitQuery(LODSparqlQueryVisitor $visitor) {
	 ...
	 * 		structure tree.
	 */
	private function traverseQuery(array &$pattern, LODSparqlQueryVisitor $visitor) {
