...
var wgUserLanguageStrings = {
	...
	'SHE_search_command'		  : "suche nächsten / öffne Suchfeld",
	'SHE_search'				  : "suche",
	'SHE_replace'				  : "ersetze",
	'SHE_replace_command'		  : "ersetze / öffne Suchfeld",
	'SHE_find_next'				  : "finde nächsten",
	'SHE_replace_all'			  : "ersetze alle Treffer",
	'SHE_reg_exp'				  : "reguläre Ausdrücke",
	...
	'SHE_reset_highlight'		  : "Highlighting zurücksetzen (falls mit Text nicht konform)",
	'SHE_help'					  : "über",
	'SHE_save'					  : "sichern",
	'SHE_load'					  : "öffnen",
	'SHE_line_abbr'				  : "Ln",
