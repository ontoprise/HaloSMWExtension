  ...
  SPARQL.activateDiscardChangesLink = function(){
    $('#discardChangesLink').live('click', function(event){
      ...
      if(initialQuery && initialQuery.length > 1){
        ...
        $('#qiSparqlParserFunction').val(SPARQL.buildParserFuncString($('#sparqlQueryText').val()));
      }
