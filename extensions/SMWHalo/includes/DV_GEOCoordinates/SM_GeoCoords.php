...
global $smwgHaloIP;
$wgAutoloadClasses['SMGeoCoordsValue'] = $smwgHaloIP . '/includes/DV_GEOCoordinates/SM_GeoCoordsValue.php';

// Registration of the Geographical Coordinate value description class.
$wgAutoloadClasses['SMGeoCoordsValueDescription'] = $smwgHaloIP . '/includes/DV_GEOCoordinates/SM_GeoCoordsValueDescription.php';
