 ...
 class SMWSemanticStoreSQL extends SMWSemanticStore {
	...
	function setup($verbose) {
 	...
 	function drop($verbose) {
        ...
        $tables = array('smw_logging', 'smw_rules');
	...
	public function setupRuleTable($verbose) {
		// add rule storage
		
            DBHelper::reportProgress("   ... Creating rule database database \n",$verbose);
        $db =& wfGetDB( DB_MASTER );
