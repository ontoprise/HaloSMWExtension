...
if ($buildAll || $build == 'smw') {  // standard scripts which are loaded always (except special pages)
	// name of output file
...
if ($build == 'OntologyBrowser' || $buildAll) { // scripts which are only loaded on OntologyBrowser Special page
...
if ($build == 'QueryInterface' || $buildAll) { // scripts which are only loaded on QueryInterface Special page
...
if ($build == 'General' || $buildAll) { // scripts which are loaded always
