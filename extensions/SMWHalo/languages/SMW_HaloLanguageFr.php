...
en cliquant sur les grosses flèches situées entre les colonnes.",
	'smw_ob_undefined_type' => '*type indéfini*',
	...
	'smw_csh_nohelp' => 'Aucune question d\'aide relevante n\'a été ajoutée au système.',
	...
	'smw_qi_reset_confirm' => 'Êtes-vous sûr de vouloir réinitialiser votre requête ?',
	'smw_qi_querytree_heading' => 'Navigation dans l\'arbre des requêtes',
	'smw_qi_main_query_name' => 'Main',
	'smw_qi_preview_result' => 'Aperçu des résultats',	
	...
	'smw_qi_tt_tcp' => 'L\'aperçu des colonnes du tableau vous permet de visualiser les colonnes qui vont apparaître dans le tableau de résultats',
	...
	'smw_qi_tt_preview' => 'Montre un aperçu complet des résultats de vos requêtes, comprenant les configurations de mise en page',
	...
	'smw_qi_tt_reset' => 'Réinitialise la requête entière',
	...
	/* SMWFindWork */
 	...
 	'smw_findwork_docu' => 'Cette page suggère des articles qui sont en quelque sorte problématiques mais que vous apprécirez éditer/corriger.',
 	'smw_findwork_user_not_loggedin' => 'Vous n\'êtes pas loggué. Il est possible d\'utiliser la page de manière anonyme, mais il est conseillé de vous identifier.', 	
 	'smw_findwork_header' => 'Les articles suggérés reflètent vos intérêts basés sur votre historique des éditions. Si vous ne savez que choisir, cliquer sur $1. Le système sélectionnera un sujet pour vous.<br /><br />Si vous voulez travailler sur un problème spécifique, vous pouvez choisir un des suivants: ',
 	...
 	'smw_findwork_generalconsistencyissues' => 'Problèmes de consistance générale',
	...
	'smw_tsa_addtoconfig3' => 'Assurez-vous aussi que l\'URL du graphe (dernier paramètre de enableSMWHalo) est valide et qu\'il ne contient pas de dièse (#).',
    ...
    'smw_tsa_norulesupport'=> 'Le driver triplestore ne supporte pas les règles, bien qu\'elles soient activées dans le wiki. Veuillez supprimer <pre>$smwgEnableFlogicRules=true;</pre> de votre LocalSettings.php, afin de ne pas obtenir d\'erreurs.',
    
	// Simple Rules formula parser
	'smw_srf_expected_factor' => 'Une fonction, variable, constante ou accolade est attendue près de $1',
	'smw_srf_expected_comma' => 'Une virgule est attendue près de $1',
	'smw_srf_expected_(' => 'Une accolade ouvrante est attendue près de $1',
	'smw_srf_expected_)' => 'Une accolade fermante est attendue près de $1',
	'smw_srf_expected_parameter' => 'Un paramètre est attendu près de $1',
	'smw_srf_missing_operator' => 'Un opérateur est attendu près de $1',
	...
	'smw_expl_explain_category' => 'Expliquer la tâche de la catégorie:',
	'smw_expl_explain_property' => 'Expliquer la tâche de la propriété:',
