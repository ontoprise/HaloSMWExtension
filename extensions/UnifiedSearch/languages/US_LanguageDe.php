...
class US_LanguageDe {
	...
	public $us_userMessages = array (
	    ...
	    'us_similar_page_does_exist' => 'Es gibt eine Seite mit einem ‰hnlichen Namen: $1',
	...
	'us_entries_per_page' => 'Eintr&auml;ge pro Seite',
	    ...
	    'us_includerules' => 'Einschlieﬂlich Regeln'
        );
	...
	public $us_pathsearchMessages = array(
		...
		'us_pathsearch_show_all_results' => 'Zeige alle Ergebnisse f√ºr diesen Pfad ($1) ...',
		'us_pathsearch_no_instances' => 'Es wurden keine Ergebnisse f√ºr den aktuellen Pfad gefunden.',
		'us_pathsearch_error_in_path' => 'Im Pfad ist ein Fehler aufgetreten.',
		'us_pathsearch_result_popup_header' => 'Alle Ergebnisse f√ºr diese Pfad',
	);        
}
