 ...
 */
class SRFTableSelectorResultPrinter extends SMWResultPrinter {
    ...
    protected function getCellForPropVals( SMWResultArray $resultArray, $outputmode ) {
        ...
        $checkbox = '<input type="checkbox" checked="true"></input>';
        
        return Html::rawElement(
            'td',
            $attribs,
            $checkbox . $this->getCellContent( $resultArray, $outputmode )
        );
    }
