...
class SMW_DILanguageDe extends SMW_DILanguage {
	...
	'smw_ti_welcome' => 'Bitte w&auml;hle zuerst ein Transport Layer Module (TLM) und danach ein Data Access Module (DAM) aus:',
	'smw_ti_selectDAM' => 'Bitte w&auml;hle ein DAM aus.',
	'smw_ti_firstselectTLM' => 'W&auml;hle zuerst das TLM aus.',
	'smw_ti_selectImport' => 'Bitte w&auml;hle eines der verf&uuml;gbaren Import Sets aus:&nbsp;&nbsp;',
	'smw_ti_inputpolicy' => 'Mit der input policy kann definiert werden, welche Informationen importiert werden sollen. Dabei k&ouml;nnen (<a href="http://www.opengroup.org/onlinepubs/007908799/xbd/re.html" target="_blank">regul&auml;re Ausdr&uuml;cke</a>) verwendet werden. 
	...
	'smw_ti_mappingPage' => 'Bitte gib den Namen des Artikels an, der die Mapping Policy enth&auml;lt:',
...
'smw_wws_s2-REST-help' => '<h4>Hilfe</h4><br/>Jetzt m&uuml;ssen Sie angeben, ob Sie die HTTP-<b>get</b> oder die HTTP-<b>post</b> Methode f&uuml;r den Web Service Aufruf verwenden m&ouml;chten. (In den meisten F&auml;llen k&ouml;nnen Sie sich f&uuml;r HTTP-get entscheiden.) ',
	...
	'smw_wws_autogenerate-alias-tooltip' => 'Aliase automatisch generieren.',
