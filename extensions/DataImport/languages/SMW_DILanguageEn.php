...
class SMW_DILanguageEn extends SMW_DILanguage {
	...
	'smw_ti_damdesc_csv' => 'Imports articles from a tabular-separated text file. You either have to pass the path to a file which is located on the server or a valid URL. One of the colums in the source must be named \'articleName\'',
