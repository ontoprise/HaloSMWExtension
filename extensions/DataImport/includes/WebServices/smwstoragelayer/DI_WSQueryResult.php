 ...
 */
class DIWSQueryResult extends SMWQueryResult {
	
	// array of result subjects
	private $mResultSubjects;
	
	public function DIWSQueryResult($printrequests, $query, $results, $store, $furtherres=false) {
 ...
 * result array
 */
class DIWSResultArray extends SMWResultArray {
    
	public function DIWSResultArray(SMWDIWikiPage $resultPage, SMWPrintRequest $printRequest, $results) {
        parent::__construct($resultPage, $printRequest, new DIWSSMWStore());
