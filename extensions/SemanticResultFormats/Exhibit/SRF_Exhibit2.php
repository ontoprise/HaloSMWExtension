...
<table width="350px" cellpadding=3>'.implode("", $lensstack).'</table>';
		...
		$ExhibitScriptSrc2 = '<script type="text/javascript" src="'.$srfgScriptPath.'/Exhibit/SRF_Exhibit2.js"></script>';
		...
		SMWOutputs::requireHeadItem('EXHIBIT1', '<script type="text/javascript" src="'.$srfgScriptPath.'/Exhibit/includes/src/webapp/api/exhibit-api.js?autoCreate=false&safe=true"></script>');
		if($timeline) SMWOutputs::requireHeadItem('EXHIBIT_time', '<script type="text/javascript" src="'.$srfgScriptPath.'/Exhibit/includes/src/webapp/extensions/time/time-extension.js"></script>');
		if($map) SMWOutputs::requireHeadItem('EXHIBIT_map', '<script type="text/javascript" src="'.$srfgScriptPath.'/Exhibit/includes/src/webapp/extensions/map/map-extension.js?gmapkey=' . $wgGoogleMapsKey . '"></script>');
		SMWOutputs::requireHeadItem('EXHIBIT_simile', '<script type="text/javascript">SimileAjax.History.enabled = false;</script>'); // not sure, just add this stuff
			...
			<tr class="exhibit-content" valign="top">
				...
				<td class="view-content">
					<div class="exhibit-view-panel" ex:role="viewPanel">
						<div class="item" ex:role="lens" style="display: none;">' . $lenssrc . '</div>
						' . implode("\n",$viewstack) . '
					</div>
				</td>
