...
*
* <BR><BR>History:<UL>
* <LI>12-14-2004                 : bug in function serialize() fixed by Sören Auer(auer@informatik.uni-leipzig.de) </LI>
* <LI>12-06-2004                 : improved namespace handling added (tobias.gauss@web.de)</LI>
* <LI>01-06-2004				 : Empty model bug fixed.</LI>
* <LI>03-25-2004				 : Bug in saveAs() fixed by inkel(inkel-php@f14web.com.ar)</LI>
* <LI>03-21-2004				 : Support for xml default namespace added
*								   Methods changed: serialize(), writeNamespaceDeclarations(), getElementText()</LI>
* <LI>11-17-2003                : Support for XMLLiterals added.</LI>
* <LI>07-27-2003                : Functions addapted to the new class tree (MemModel extends Model)</LI>
* <LI>07-24-2003                : Bug in writeAbsoluteResourceReference() fixed by Paul Cowles(paul@semaview.com) </LI>
* <LI>02-21-2003                : saveAs method added.</LI>
* <LI>02-12-2003                : rdf:type and bNode reference bug fixed.</LI>
* <LI>01-15-2003                : pass-by-reference bug fixed.</LI>
* <LI>01-10-2003                : rdf:datatype and $useAttributes bug fixed.</LI>
* <LI>12-04-2002                : Added support for rdf:datatype (writeContentStatements())</LI>
* <LI>12-04-2002                : Added rdf:nodeID attribute for blank nodes (writeSubjectURI, writeResourceReference)</LI>
* <LI>10-03-2002                : Bug in collectNamespaces() fixed.</LI>
* <LI>09-15-2002                : First version of this class.</LI>
* </UL>
*
* @version  V0.9.1
