	...
	function setup($verbose = true) {
		...
		$this->setupTable($smw_relations,
		              array('subject_id'        => 'INT(8) UNSIGNED NOT NULL',
		                    ...
		                    'subject_title'     => 'VARCHAR(255) COLLATE '.$smwgDefaultCollation.' NOT NULL',
		                    'relation_title'    => 'VARCHAR(255) COLLATE '.$smwgDefaultCollation.' NOT NULL',
		                    'object_namespace'  => 'INT(11) NOT NULL',
		                    'object_title'      => 'VARCHAR(255) COLLATE '.$smwgDefaultCollation.' NOT NULL',
		...
		$this->setupTable($smw_attributes,
		              array('subject_id'        => 'INT(8) UNSIGNED NOT NULL',
		                    'subject_namespace' => 'INT(11) NOT NULL',
		                    'subject_title'     => 'VARCHAR(255) COLLATE '.$smwgDefaultCollation.' NOT NULL',
		                    'attribute_title'   => 'VARCHAR(255) COLLATE '.$smwgDefaultCollation.' NOT NULL',
		                    'value_unit'        => 'VARCHAR(63) COLLATE '.$smwgDefaultCollation.'',
		                    'value_datatype'    => 'VARCHAR(31) COLLATE '.$smwgDefaultCollation.' NOT NULL', /// TODO: remove value_datatype column
		                    'value_xsd'         => 'VARCHAR(255) COLLATE '.$smwgDefaultCollation.' NOT NULL',
		...
		$this->setupTable($smw_specialprops,
		              array('subject_id'        => 'INT(8) UNSIGNED NOT NULL',
		                    ...
		                    'value_string'      => 'VARCHAR(255) COLLATE '.$smwgDefaultCollation.' NOT NULL'), $db, $verbose);
		...
		$this->setupTable($smw_subprops,
		              array('subject_title'     => 'VARCHAR(255) COLLATE '.$smwgDefaultCollation.' NOT NULL',
		                    'object_title'      => 'VARCHAR(255) COLLATE '.$smwgDefaultCollation.' NOT NULL'), $db, $verbose);
...
///// Private methods /////
	...
	protected function getCategoryTable($cats, &$db) {
		...
		$db->query( 'CREATE TEMPORARY TABLE ' . $tablename .
		            '( title VARCHAR(255) COLLATE '.$smwgDefaultCollation.' NOT NULL )
