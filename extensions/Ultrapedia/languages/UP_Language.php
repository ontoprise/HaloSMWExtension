...
abstract class UP_Language {
	...
	protected $smwUltraPediaDatatypes;
	protected $smwUltraPediaNamespaces;
	protected $smwUltraPediaNamespaceAliases;
	 ...
	 * 
	 * The language files of the UltraPedia extension contain a mapping from special 
	...
	function getUltraPediaDatatype($datatypeID) {
		return $this->smwUltraPediaDatatypes[$datatypeID];
	}
	...
	public function getNamespace($namespaceID) {
		return $this->smwUltraPediaNamespaces[$namespaceID];
	}
	
	/**
	 * Returns the array with all namespaces of the UltraPedia extension.
	 *
	 * @return string
	...
	public function getNamespaces() {
		return $this->smwUltraPediaNamespaces;
	}
	
	/**
	 * Returns the array with all namespace aliases of the UltraPedia extension. 
	 *
	 * @return string
	...
	public function getNamespaceAliases() {
		return $this->smwUltraPediaNamespaceAliases;
	}
