...
Ext.onReady(function(){
	...
	for(var i=0;i<AjaxInternalLinks.data.length;++i) {
	    new Ext.ToolTip({
	        ...
	        width: 200,
	        autoLoad: {url: AjaxInternalLinks.baseUrl + '/index.php?action=ajax&rs=smwf_up_Access&rsargs[]=ajaxSparql&rsargs[]=' + i + ',[[' +AjaxInternalLinks.data[i].page + ']] | ?Abstract | format=list'},
