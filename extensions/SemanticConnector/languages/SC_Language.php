...
abstract class SC_Language {
	...
	protected $smwConnectorDatatypes;
	protected $smwConnectorNamespaces;
	protected $smwConnectorNamespaceAliases;
	 ...
	 * 
	 * The language files of the Connector extension contain a mapping from special 
	...
	function getConnectorDatatype($datatypeID) {
		return $this->smwConnectorDatatypes[$datatypeID];
	}
	...
	public function getNamespace($namespaceID) {
		return $this->smwConnectorNamespaces[$namespaceID];
	}
	
	/**
	 * Returns the array with all namespaces of the Connector extension.
	 *
	 * @return string
	...
	public function getNamespaces() {
		return $this->smwConnectorNamespaces;
	}
	
	/**
	 * Returns the array with all namespace aliases of the Connector extension. 
	 *
	 * @return string
	...
	public function getNamespaceAliases() {
		return $this->smwConnectorNamespaceAliases;
	}
