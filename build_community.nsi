...
!define PRODUCT "SMW+ Community"
!define PRODUCT_CAPTION "SMW+ Community"
...
Function changeConfigForFullXAMPP
    ...
    nsExec::ExecToLog '"$INSTDIR\php\php.exe" "$INSTDIR\htdocs\mediawiki\installer\changeLS.php" phpInterpreter="$INSTDIR\php\php.exe" \
        ...
        smwgSemanticAC=false smwgGardeningBotDelay=100 wgScriptPath="/mediawiki" ls=LocalSettings.php.community.tmpl'
